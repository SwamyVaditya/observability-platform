...
- **[cluster_name](ca://s?q=Terraform_variables_cluster_name)** — name of the K3D cluster (default: `observability`)
- **[servers](ca://s?q=Terraform_variables_servers_count)** — number of server nodes (default: `1`)
- **[agents](ca://s?q=Terraform_variables_agents_count)** — number of agent nodes (default: `2`)
- **[storage_class](ca://s?q=Terraform_variables_storage_class)** — default PVC storage class (default: `standard`)
- **[argocd_namespace](ca://s?q=Terraform_variables_argocd_namespace)** — namespace for Argo CD (default: `argocd`)
- **[observability_namespace](ca://s?q=Terraform_variables_observability_namespace)** — namespace for observability workloads (default: `observability`)
- **[helm_chart_versions](ca://s?q=Terraform_variables_Helm_chart_versions)** — pinned versions for Calico, cert‑manager, Argo CD
...
Here’s a **README.md** for your `infra/terraform/` directory. It’s written in a production‑style tone, guiding engineers through prerequisites, cross‑platform setup, and execution.
